 ...
 */
final class Version20190416195122 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dawka ADD odstep_min_interval VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', ADD odstep_max_interval VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dawka DROP odstep_min_interval, DROP odstep_max_interval');
    }
}
