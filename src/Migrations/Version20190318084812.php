 ...
 */
final class Version20190318084812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE schemat CHANGE szczepionka_id podawania_id INT NOT NULL');
        $this->addSql('ALTER TABLE schemat ADD CONSTRAINT FK_B7E43138B53C02 FOREIGN KEY (podawania_id) REFERENCES szczepionka (id)');
        $this->addSql('CREATE INDEX IDX_B7E43138B53C02 ON schemat (podawania_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B7E43138B53C02 ON schemat');
        $this->addSql('ALTER TABLE schemat CHANGE podawania_id szczepionka_id INT NOT NULL');
